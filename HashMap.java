 ...
 class HashMapIterator implements Iterator<HashMap.Entity>{
        ...
        public boolean hasNext() {
            ...
            while (currentIndex < buckets.length) {
                ...
                // if bucket is null or bucket exists, but empty - skip iteration
                 if (bucket == null || bucket.head == null) {
                    currentIndex++;
                    continue;
                 }
                 
                 currentBucketHead = bucket.head;
                 return true;
        ...
        public Entity next() {
            ...
            Entity entity = currentBucketHead.value;
